...
%application des conditions limites de Dirichlet
M(1,:) = 0; M(1,1) = 1; M(Nx+1,:) = 0; M(Nx+1,Nx+1) = 1;
N(1,:) = 0; N(1,1) = 1; N(Nx+1,:) = 0; N(Nx+1,Nx+1) = 1;
...
%mov = VideoWriter(strcat('./VideoDirichlet',strcat(m,strcat('Cas',strcat(num2str(k),'.avi')))));
for i=1:length(t)
